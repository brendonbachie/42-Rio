...
- Write access to create `/home/bgomes-b/data/{wordpress,mariadb}`
- Ability to edit `/etc/hosts` for `bgomes-b.42.fr`
...
```bash
mkdir -p /home/bgomes-b/data/wordpress /home/bgomes-b/data/mariadb
```

5. Map the domain:

```bash
echo '127.0.0.1 bgomes-b.42.fr' | sudo tee -a /etc/hosts
```
...
|-------------------|--------------------|-----------------------------------|
| `wordpress_data`  | `/var/www/html`    | `/home/bgomes-b/data/wordpress`   |
| `mariadb_data`    | `/var/lib/mysql`   | `/home/bgomes-b/data/mariadb`     |
